---
name: go-reviewer
description: Review Go implementations in this project against spec acceptance tests. Provides the review checklist, test verification, lint checks, quality standards, and verdict format. Use when reviewing implemented Go code, verifying tests, or performing a code review after implementation.
---
