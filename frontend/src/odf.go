...
<office:document-styles xmlns:office="urn:oasis:names:tc:opendocument:xmlns:office:1.0" xmlns:style="urn:oasis:names:tc:opendocument:xmlns:style:1.0" xmlns:number="urn:oasis:names:tc:opendocument:xmlns:datastyle:1.0" office:version="1.4"><office:styles><number:number-style style:name="TB"><number:text>  </number:text><number:number number:decimal-places="1" number:min-decimal-places="1" number:min-integer-digits="1" number:grouping="true" number:display-factor="1000000000000"/><number:text>TB</number:text></number:number-style><number:number-style style:name="GB"><number:text>   </number:text><number:number number:decimal-places="1" number:min-decimal-places="1" number:min-integer-digits="1" number:grouping="true" number:display-factor="1000000000"/><number:text>GB</number:text></number:number-style><number:number-style style:name="Bytes"><number:text>  </number:text><number:number number:min-integer-digits="1"/><style:map style:condition="value()&gt;=1000000000000" style:apply-style-name="TB"/><style:map style:condition="value()&lt;1000000000000" style:apply-style-name="GB"/></number:number-style></office:styles></office:document-styles>`
