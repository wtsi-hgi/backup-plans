...
export const symbols = svg({ style: `width: 0; height: 0` }, [
  ...
  symbol({ id: "lock", viewBox: "0 0 100 100" }, [
    path({
      d: "M5,53 s0,-15 15,-15 h60 s15,0 15,15 v32 s0,15 -15,15 h-60 s-15,0 -15,-15 z M45,78 l2,-8 c-7,-12 13,-12 6,0 l2,8 z",
      fill: "#000",
      stroke: "#000",
      "stroke-linejoin": "round",
      "fill-rule": "evenodd",
  ...
  symbol(
    { id: "copy", viewBox: "0 0 34 37" },
    path({
      d: "M14,6 h-13 v30 h21 v-22 z v8 h8 M12,6 v-5 h13 l8,8 v22 h-11 m11,-22 h-8 v-8 M6,20 h11 m-11,5 h11 m-11,5 h11",
      stroke: "currentColor",
      fill: "none",
    })
  ),
