...
export const getTree = (dir: string) => getURL<Tree>("api/tree", { dir }),
	...
	removeRules = (dir: string, match: string[]) => getURL<void>("api/rules/remove", {}, { dir, match }),
	getReportSummary = () => getURL<ReportSummary>("api/report/summary"),
	setDirDetails = (dir: string, frequency: number, frozen: boolean, meltToggle: boolean, review: number, remove: number) => getURL<void>("api/dir/setdetails", {}, { dir, frequency, frozen, meltToggle, review, remove }),
	...
	updateCollection = (id: number, name: string, description: string) => getURL<void>("api/collections/update", {}, { id, name, description }),
